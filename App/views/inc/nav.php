<nav class="navbar py-3 navbar-expand-lg border-bottom border-3 border-white">
  <div class="container">
    <!-- Logo -->
    <a class="navbar-brand fs-4" href="<?php echo APP_URL; ?>/contacts">Contactos</a>
    <!-- Toggler button -->
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <div class="offcanvas-header border-bottom border-2 border-white">
        <h5 class="offcanvas-title" id="offcanvasNavbarLabel">Contactos</h5>
        ...
        <?php if (isset($_SESSION['user'])) { ?>
          <ul class="navbar-nav justify-content-center align-items-center flex-grow-1 pe-3 fs-5">
            <li class="nav-item mx-2">
              <a class="nav-link <?php echo str_contains($_SERVER['REQUEST_URI'], '/contacts') ? 'active' : '' ?>"
                aria-current="page" href="<?php echo APP_URL; ?>/contacts">Contactos</a>
            </li>
          </ul>
        <?php } ?>
        ...
        <div class="d-flex flex-column flex-lg-row justify-content-center align-items-center gap-3">
          ...
          <?php if (!isset($_SESSION['user'])) { ?>
            ...
            <a href="<?php echo APP_URL; ?>/register"
              class="text-white text-decoration-none px-3 py-1 bg-primary rounded-4">Crear cuenta</a>
          <?php } ?>
